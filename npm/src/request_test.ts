...
import type { NativeRequestOptions } from "./http_server_native.js";
...
function createMockNativeRequest(
  ...
  const request: globalThis.Request = new (({ ...denoShim, ...globalThis }) as any).Request(
    url,
    requestInit,
  );
