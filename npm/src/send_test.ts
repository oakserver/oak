...
test({
  ...
  async fn() {
    ...
    const fixture = await denoShim.Deno.readFile("./fixtures/test.json.gz");
...
test({
  ...
  async fn() {
    const { context } = setup("/test.json");
    const fixture = await denoShim.Deno.readFile("./fixtures/test.json.br");
...
test({
  ...
  async fn() {
    const { context } = setup("/test.json");
    const fixture = await denoShim.Deno.readFile("./fixtures/test.json");
    await send(context, context.request.url.pathname, {
      root: "./fixtures",
      maxbuffer: 0,
    });
...
test({
  ...
  async fn() {
    ...
    const fixture = await denoShim.Deno.readFile("./fixtures/test file.json");
    await send(context, context.request.url.pathname, {
      root: "./fixtures",
      maxbuffer: 0,
    });
...
test({
  ...
  async fn() {
    const { context } = setup("/test.json");
    const fixture = await denoShim.Deno.readFile("./fixtures/.test/test.json");
    await send(context, context.request.url.pathname, {
      root: "./fixtures/.test",
      maxbuffer: 0,
    });
...
test({
  ...
  async fn() {
    const { context } = setup("/test.json");
    const fixtureStat = await denoShim.Deno.stat("./fixtures/test.json");
...
test({
  ...
  async fn() {
    ...
    const fixture = await denoShim.Deno.readFile("./fixtures/test.jpg");
    await send(context, context.request.url.pathname, {
      root: "./fixtures",
      maxbuffer: 300000,
    });
...
test({
  name: "range header",
  ignore: denoShim.Deno.build.os === "windows",
  async fn() {
    const { context } = setup("/test.json");
...
test({
  ...
  async fn() {
    ...
    const fixture = await denoShim.Deno.readFile("./fixtures/test.importmap");
    await send(context, context.request.url.pathname, {
      root: "./fixtures",
      contentTypes: {
