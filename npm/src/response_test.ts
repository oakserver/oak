...
import { REDIRECT_BACK, Response } from "./response.js";
...
function createMockRequest({
  ...
  return { accepts, headers: new denoShim.Headers(headers) } as any;
}
...
test({
  ...
  fn() {
    assertEquals(
      denoShim.Deno.inspect(new Response(createMockRequest())),
