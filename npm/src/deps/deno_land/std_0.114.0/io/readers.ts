...
export class MultiReader implements denoShim.Deno.Reader {
  private readonly readers: denoShim.Deno.Reader[];
 ...
 */
export class LimitedReader implements denoShim.Deno.Reader {
  constructor(public reader: denoShim.Deno.Reader, public limit: number) {}
