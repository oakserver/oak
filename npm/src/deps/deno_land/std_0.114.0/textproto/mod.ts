...
import type { BufReader, ReadLineResult } from "../io/buffer.js";
...
export class TextProtoReader {
   ...
   * 	}
   */
  async readMIMEHeader(): Promise<denoShim.Headers | null> {
    const m = new denoShim.Headers();
    ...
    while (true) {
      ...
      if (kv === null) throw new denoShim.Deno.errors.UnexpectedEof();
