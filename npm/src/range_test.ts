...
import { assert, assertEquals, assertThrows } from "./test_deps.js";

import { concat, copyBytes } from "./deps.js";
...
class MockFile implements denoShim.Deno.Seeker, denoShim.Deno.Reader, denoShim.Deno.Closer {
  #buf: Uint8Array;
  #closed = false;
  #offset = 0;
  ...
  seek(offset: number, whence: denoShim.Deno.SeekMode): Promise<number> {
    assert(whence === denoShim.Deno.SeekMode.Start);
